...
class canvas_GUI:
    ...
    def draw_window(self):
        ...
        #self.adjustment_area.grid_columnconfigure(0, weight=1)
        self.adjustment_area.place(x=0, y=canvas_window_height - (int)(canvas_window_height/4))
        #self.adjustment_area.pack(side=tk.BOTTOM, fill=tk.BOTH, expand=False)
        #self.adjustment_area.grid_propagate(False)
